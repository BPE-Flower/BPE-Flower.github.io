...
sliders.forEach((slider, index) => {
  slider.addEventListener("input", (event) => {
    ...
    const level = Math.round(
      ((event.target.value / 100 - 0.5) * (5 - 1)) / (1.5 - 0.5) + 1,
    );
...
document
  .getElementById("saveGraphButton")
...
document.getElementById("infoIcon").addEventListener("click", function () {
  // shows the pop up explaining this website and hwo I am
  alert(
    "Welcome to the Big Picture Education Flower!\n\n" +
      "I’m Lucas Newman (also known as Squidly1408). I studied at Cooks Hill Campus, a Big Picture Education school in Newcastle, where I quickly realised there wasn’t a digital version of the BPE Flower — a tool that would have made projects like my Gateway and senior years far easier to plan, structure, and present.\n\n" +
      "As I developed my skills and later became a Software Engineer, I decided to build the tool I wished I had as a student. That idea became the BPE Education Flower Project — a digital, interactive version designed to support students, advisors, and schools.\n\n" +
      "After developing the platform, I partnered with Big Picture Education Australia to create and code a version for their official website, helping bring the Flower into a modern, accessible digital space.\n\n" +
      "If you’d like to learn more about me or get in touch:\n" +
